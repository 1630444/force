...
<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena&view=search'); ?>" method="post" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
	...
	<div class="btn-toolbar pull-right">
		<div class="btn-group">
			<button class="btn btn-default btn-small" type="button" data-toggle="collapse" data-target="#search" aria-expanded="false" aria-controls="search"><?php echo KunenaIcons::collapse();?></button>
		</div>
	</div>
	<h1>
	...
	<div class="well">
		...
		<button type="button" class="btn btn-default btn-small pull-right" data-toggle="collapse" data-target="#search-options" aria-expanded="false" aria-controls="search-options"><?php echo KunenaIcons::collapse();?></button>
		<h2>
