				...
				<div class="control-group">
					...
					<div id="recaptcha-msg" class="hidden" recaptcha-status="<?php echo (JPluginHelper::isEnabled('captcha','recaptcha') ?  'enabled' : 'disabled'); ?>">
						...
						if(!JPluginHelper::isEnabled('captcha','recaptcha')){
							...
							$captcha_link = 'index.php?option=com_plugins&task=plugin.edit&extension_id='.$pluginsId->extension_id;
				...
				<div class="ui-sortable jsn-sortable-disable">
					...
					<div class="form-payments ui-state-default jsn-iconbar-trigger">
						...
						<div class="payment-total-money">
                            ...
                            <!-- Extra Fee -->
                          <!--  <input type="hidden" id="jform_payment_extra_fee_type" name="jsn_form_total_money[extra_fee_type]" value="<?php echo !empty($formSettings->extra_fee_type) ? $formSettings->extra_fee_type : 'none'; ?>">
                            <input type="hidden" id="jform_payment_extra_fee_value" name="jsn_form_total_money[extra_fee_value]" value="<?php echo !empty($formSettings->extra_fee_value) ? $formSettings->extra_fee_value : '0'; ?>">
                            <input type="hidden" id="jform_payment_extra_fee_text" name="jsn_form_total_money[extra_fee_text]" value="<?php echo !empty($formSettings->extra_fee_text) ? $formSettings->extra_fee_text : JText::_('JSN_UNIFORM_EXTRA_FEE');?>">
                            <input type="hidden" id="jform_payment_total_includes_extra_fee_text" name="jsn_form_total_money[total_includes_extra_fee_text]" value="<?php echo !empty($formSettings->total_includes_extra_fee_text) ? $formSettings->total_includes_extra_fee_text : JText::_('JSN_UNIFORM_TOTAL_INCLUDES_EXTRA_FEE');?>">-->
						</div>
						<?php } ?>
						<div class="jsn-iconbar">
...
<div id="form-action">
	<div class="row-fluid">
					...
					<div class="jsn-bootstrap emailsettings email-submiter">
						<fieldset style="border: none;margin: 0;padding: 0;">
                            <!--<div class="form-horizontal">
                                <div class="control-group">
                                    <label class="control-label jsn-label-des-tipsy" original-title="<?php echo JText::_('JSN_UNIFORM_EMAIL_CONFIRM_SENDING_EMAIL_DESC'); ?>"><?php echo JText::_('JSN_UNIFORM_EMAIL_CONFIRM_SENDING_EMAIL_LABEL'); ?></label>
                                    <div class="controls">
                                        <label class="radio inline">
                                            <input type="radio" name="jform[email-settings][submiter][confirm_sending_email]" value="0" <?php if (empty($item->confirm_sending_email) || ! (int) $item->confirm_sending_email) echo 'checked="checked"'; ?> /> <?php echo JText::_('JNO'); ?>
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="jform[email-settings][submiter][confirm_sending_email]" value="1" <?php if (!empty($item->confirm_sending_email) && (int) $item->confirm_sending_email) echo 'checked="checked"'; ?> /> <?php echo JText::_('JYES'); ?>
                                        </label>
                                    </div>
                                </div>
                                <hr />
		...
		<div class="form-horizontal post-submission-action">
