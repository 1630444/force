...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2018-12-30' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2018-12-30';
		self::$version_name  = ('Janus' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Janus';
	}
