...
class ModulesRenderer extends DocumentRenderer
{
	...
	public function render($position, $params = array(), $content = null)
	{
		...
		\JEventDispatcher::getInstance()->trigger( 'onBeforeRenderModulePosition', array($position, &$params, &$content) );
		...
		// <!-- Modified to support Site Manager feature of JSN PowerAdmin :: Begin
		\JEventDispatcher::getInstance()->trigger( 'onAfterRenderModulePosition', array($position, &$params, &$buffer) );
		// Modified to support Site Manager feature of JSN PowerAdmin :: End -->
